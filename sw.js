...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-ve4wSmtV.js',
  './assets/Countdown-De_uf5CG.js',
  './assets/Dashboard-DGj6und1.js',
  './assets/DeadlinesPage-CktpIWuk.js',
  './assets/GlowCard-I2v_o0dc.js',
  './assets/Journal-DF1l4pR2.js',
  './assets/Money-COGoU03o.js',
  './assets/Review-CUeowKlv.js',
  './assets/arrow-right-QKwX_ljm.js',
  './assets/chevron-right-DiFMztXV.js',
  './assets/coins-BhvB_PLf.js',
  './assets/index-BF9pzIIX.js',
  './assets/index-CGg4cdvt.css',
  './assets/sparkles-D5nYM6Ia.js',
  './assets/trending-up-CWVSI56t.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
