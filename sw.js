...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-Cs1t0fUH.js',
  './assets/Countdown-OXTXHIfT.js',
  './assets/Dashboard-CyUsx4EM.js',
  './assets/DeadlinesPage-D-9MiuGI.js',
  './assets/GlowCard-DxEuVT0r.js',
  './assets/Journal-5-W_nvHo.js',
  './assets/Money-DEYouF-M.js',
  './assets/Review-wmo-jFY-.js',
  './assets/arrow-right-Edzb1zDm.js',
  './assets/chevron-right-Be2W-fhA.js',
  './assets/coins-DDywr7sl.js',
  './assets/flag-BJe2ZdZH.js',
  './assets/index-5qRkBYd4.js',
  './assets/index-CnJ7-87h.css',
  './assets/maximize-2-B-OfxQu0.js',
  './assets/sparkles-D71FtaHr.js',
  './assets/trending-up-DGSg61xJ.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
