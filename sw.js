...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-D6RXZu83.js',
  './assets/Countdown-CcVreIEy.js',
  './assets/Dashboard-_jheXEKX.js',
  './assets/DeadlinesPage-YzmRmOIU.js',
  './assets/GlowCard-BCVR-R_E.js',
  './assets/Journal-CUyjWwSL.js',
  './assets/Money-B6gX-cd_.js',
  './assets/Review-DhspW_OM.js',
