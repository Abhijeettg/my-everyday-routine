...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-DVpeetLS.js',
  './assets/Countdown-CwTQf0vG.js',
  './assets/Dashboard-Cn_74lm0.js',
  './assets/DeadlinesPage-C_5orvJo.js',
  './assets/GlowCard-D2i41kKX.js',
  './assets/Journal-Cs5ZPcpY.js',
  './assets/Money-BdqjqDzJ.js',
  './assets/Review-BRAxOM6q.js',
  './assets/arrow-right-CKgzNMR9.js',
  './assets/chevron-right-CghjPtR9.js',
  './assets/coins-ZbZL6Ie2.js',
  './assets/index-BWNFczyn.css',
  './assets/index-kobYkIlv.js',
  './assets/sparkles-BTVyMGjv.js',
  './assets/trending-up-Bvwjd-3t.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
