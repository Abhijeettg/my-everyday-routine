...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-Dk7aa08W.js',
  './assets/Countdown-Cs1NL_fQ.js',
  './assets/Dashboard-CwBu48l5.js',
  './assets/DeadlinesPage-DVqvxvCC.js',
  './assets/GlowCard-DdqHhIBp.js',
  './assets/Journal-DiylN7B9.js',
  './assets/Money-BFvB20qD.js',
  './assets/Review-D_R_QMQK.js',
  './assets/arrow-right-DNVksXrx.js',
  './assets/chevron-right-DWEYQZ0a.js',
  './assets/coins-CxrAdNad.js',
  './assets/flag-DKNDPG1p.js',
  './assets/index-BRDpJJNI.js',
