...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-BgoHpWez.js',
  './assets/Countdown-74VKqId0.js',
  './assets/Dashboard-BKC5w50v.js',
  './assets/DeadlinesPage-Dyki2KBT.js',
  './assets/GlowCard-BvbdWZhD.js',
  './assets/Journal-BIYyJVv7.js',
  './assets/Money-CjAAvLdU.js',
  './assets/Review-LLd8C4Vr.js',
  './assets/arrow-right-DvfPQSjS.js',
  './assets/chevron-right-C51EuGU3.js',
  './assets/coins-SI2eTdY4.js',
  './assets/index-DIlzo2qI.js',
  './assets/index-U3qztvXF.css',
  './assets/sparkles-q28Gpnk6.js',
  './assets/trending-up-gHhHX7Qb.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
