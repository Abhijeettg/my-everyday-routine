...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-B6chdcEb.js',
  './assets/Countdown-17m2YFbT.js',
  './assets/Dashboard-B4k-MLHN.js',
  './assets/DeadlinesPage-Dqim8O2R.js',
  './assets/GlowCard-DHXu5vAv.js',
  './assets/Journal-DUiNZoWq.js',
  './assets/Money-DxFS2qA5.js',
  './assets/Review-BbyeLtfu.js',
