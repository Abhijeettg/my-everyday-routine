...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-EvVFEby4.js',
  './assets/Countdown-D9vWqAYR.js',
  './assets/Dashboard-mLqAiXhp.js',
  './assets/DeadlinesPage-7I_UCYYm.js',
  './assets/GlowCard-X_F1tLo1.js',
  './assets/Journal-CGMRS1A0.js',
  './assets/Money-DUqkD8fv.js',
  './assets/Review-DNeoN3cR.js',
  './assets/arrow-right-yhEcDHFg.js',
  './assets/chevron-right-Bj4CGNDY.js',
  './assets/coins-DpQagawl.js',
  './assets/flag-Cn4lwu7q.js',
  './assets/index-C2S0lfRG.js',
  './assets/index-CH2up2hX.css',
  './assets/maximize-2-BKx6qGVx.js',
  './assets/sparkles-BKty7TuE.js',
  './assets/trending-up-Cesegmbo.js',
  './assets/ui-BEOUEeO3.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
