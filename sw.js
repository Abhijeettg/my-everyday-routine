...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-B-j-zMxe.js',
  './assets/Countdown-CTyhCZyx.js',
  './assets/Dashboard-DPZ1-OaZ.js',
  './assets/DeadlinesPage-B0TW-2HW.js',
  './assets/GlowCard-C0XY5z46.js',
  './assets/Journal-CZyGqFDu.js',
  './assets/Money-D7b_AvqK.js',
  './assets/Review-BB9CQcRJ.js',
  './assets/arrow-right-BINC136F.js',
  './assets/chevron-right-PSdDi89w.js',
  './assets/coins-B19chvqH.js',
  './assets/index-CCCHtvlt.js',
  './assets/index-DKuezk7L.css',
  './assets/sparkles-BuzrM3GQ.js',
  './assets/trending-up-CIGbHps7.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
