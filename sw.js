...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-dHCtQ7eo.js',
  './assets/Countdown-G9YcU401.js',
  './assets/Dashboard-C2k2grT6.js',
  './assets/DeadlinesPage-BBpxc6SZ.js',
  './assets/GlowCard-kmMy-Xl2.js',
  './assets/Journal-D-UF0f0f.js',
  './assets/Money-CDRQAUKj.js',
  './assets/Review-PnjfXsNn.js',
  './assets/arrow-right-DCTfTGz5.js',
  './assets/chevron-right-DyVRRRLy.js',
  './assets/coins-CvIfMbex.js',
  './assets/index-CFMsExZn.js',
  './assets/index-VPO8okKx.css',
  './assets/sparkles-CehaNUg0.js',
  './assets/trending-up-BXmgEL52.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
