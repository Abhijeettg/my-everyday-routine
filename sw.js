...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-DdI0mRPy.js',
  './assets/Countdown-BnB4YDun.js',
  './assets/Dashboard-DD0BTwwr.js',
  './assets/DeadlinesPage-DscGjVWd.js',
  './assets/GlowCard-DyHSt19Q.js',
  './assets/Journal-XQ4vXYcS.js',
  './assets/Money-esr43VFu.js',
  './assets/Review-DLmYdsTU.js',
  './assets/arrow-right-D0-WiqJo.js',
  './assets/chevron-right-DofT2ZyM.js',
  './assets/coins-B0Jtr8tS.js',
  './assets/index-TREWmM2f.js',
  './assets/index-y70R2j8u.css',
  './assets/sparkles-lzgk2wpz.js',
  './assets/trending-up-BfKRD0_3.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
