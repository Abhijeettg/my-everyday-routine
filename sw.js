...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-BjBW30LP.js',
  './assets/Countdown-CcMNEXsL.js',
  './assets/Dashboard-Cjd05QPJ.js',
  './assets/DeadlinesPage-D0w5CDSJ.js',
  './assets/GlowCard-7wJbpUrw.js',
  './assets/Journal-MA92V_5l.js',
  './assets/Money-RpJJyPJD.js',
  './assets/Review-DWuLALhA.js',
  './assets/arrow-right-CjbEWRXP.js',
  './assets/chevron-right-eGmfna2f.js',
  './assets/coins-CuQi-lOu.js',
  './assets/flag-BgKEdf81.js',
  './assets/index-B29JXLjn.css',
  './assets/index-DkcKTnE6.js',
  './assets/sparkles-BHTQCi1-.js',
  './assets/trending-up-CgwJO6XD.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
