...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-uD1t8tZo.js',
  './assets/Countdown-EvQBMCjX.js',
  './assets/Dashboard-B72x7s2d.js',
  './assets/DeadlinesPage-De6ifDRZ.js',
  './assets/GlowCard-DX73M8pL.js',
  './assets/Journal-RQl63diM.js',
  './assets/Money-CoR4j-Au.js',
  './assets/Review-BGPTCqYa.js',
  './assets/arrow-right-CANHry1B.js',
  './assets/chevron-right-CZCj4TOg.js',
  './assets/coins-y99w1nbA.js',
  './assets/flag-CR2_dLr_.js',
  './assets/index-B29JXLjn.css',
  './assets/index-C7xqzzxr.js',
  './assets/sparkles-C-RKXuIy.js',
  './assets/trending-up-gzrPVWpu.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
