...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-DnSYrLws.js',
  './assets/Countdown-CIn12XLX.js',
  './assets/Dashboard-KIEva5Mq.js',
  './assets/DeadlinesPage-S4wtJTJR.js',
  './assets/GlowCard-sIPOlWxa.js',
  './assets/Journal--g1t1jOL.js',
  './assets/Money-BOeEoLxO.js',
  './assets/Review-BMvHznud.js',
  './assets/arrow-right-CJq8DojH.js',
  './assets/chevron-right-Bc4Yhw4z.js',
  './assets/coins-B2AIIzrI.js',
  './assets/flag-DuHl1_ou.js',
  './assets/index-A9YyWANz.css',
  './assets/index-Cm0nPt21.js',
  './assets/maximize-2-BPZtjE0X.js',
  './assets/sparkles-BGYu2A1A.js',
  './assets/trending-up-C4l4GV-3.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
