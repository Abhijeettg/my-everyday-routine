...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-DiQ3VViB.js',
  './assets/Countdown-pmfyazml.js',
  './assets/Dashboard-BTNWVKX2.js',
  './assets/DeadlinesPage-D91lXig0.js',
  './assets/GlowCard-BieptPFl.js',
  './assets/Journal-Dt_22eqP.js',
  './assets/Money-BlwpKxKm.js',
  './assets/Review-DY5anNDi.js',
  './assets/arrow-right-DMBjTHGk.js',
  './assets/chevron-right-DDNXGDP-.js',
  './assets/coins-BFXCgDfo.js',
  './assets/index-DaJUv-uV.js',
  './assets/index-y70R2j8u.css',
  './assets/sparkles-DL84RrJ0.js',
  './assets/trending-up-DCkop9nx.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
