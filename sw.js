...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-WJjkGKuB.js',
  './assets/Countdown-eZngArVA.js',
  './assets/Dashboard-DyY3SVap.js',
  './assets/DeadlinesPage-K9TgAy0R.js',
  './assets/GlowCard-CVJID9E0.js',
  './assets/Journal-BsqDfOfn.js',
  './assets/Money-YbkYCSQR.js',
  './assets/Review-BlONugpJ.js',
  './assets/arrow-right-BvM6Atnk.js',
  './assets/chevron-right-oaBLvS82.js',
  './assets/coins-DBY3QRdw.js',
  './assets/index--5gvQsR0.js',
  './assets/index-C1_Dou0E.css',
  './assets/sparkles-DnJY9FzN.js',
  './assets/trending-up-CqF0M8g7.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
