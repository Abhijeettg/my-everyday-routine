...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-B2VEGMYK.js',
  './assets/Countdown-BGGcXDKS.js',
  './assets/Dashboard-C5XFbZ2R.js',
  './assets/DeadlinesPage-DC76Rsj-.js',
  './assets/GlowCard-VgL-HpKf.js',
  './assets/Journal-DrvezCK2.js',
  './assets/Money-BG8L_Hhx.js',
  './assets/Review-DQTNnAUn.js',
  './assets/arrow-right-_yOtIZyn.js',
  './assets/chevron-right-C0nlZISE.js',
  './assets/coins-Cb0rslZF.js',
  './assets/index-D1tkyshE.js',
  './assets/index-y70R2j8u.css',
  './assets/sparkles-BgTAYy9h.js',
  './assets/trending-up-MCGB7u28.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
