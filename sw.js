...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-B0vxGKY-.js',
  './assets/Countdown-IbANAtvJ.js',
  './assets/Dashboard-Uky1Kot9.js',
  './assets/DeadlinesPage-D1tGKPtl.js',
  './assets/GlowCard-hQkN9PN-.js',
  './assets/Journal-B7sz6Znm.js',
  './assets/Money-jaNzS53L.js',
  './assets/Review-BDM5tF_s.js',
  './assets/arrow-right-CnWpyCk4.js',
  './assets/chevron-right-D9T-YH9x.js',
  './assets/coins-Ba5MJseJ.js',
  './assets/index-CpG3owgJ.css',
  './assets/index-xnPVh2uJ.js',
  './assets/sparkles-D4O-nTvj.js',
  './assets/trending-up-DzDi-mOt.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
