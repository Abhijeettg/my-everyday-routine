...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-DDBXW6o0.js',
  './assets/Countdown-BXvsFg-5.js',
  './assets/Dashboard-VZzO_JPU.js',
  './assets/DeadlinesPage-Bxw2XUkj.js',
  './assets/GlowCard-6370B4PB.js',
  './assets/Journal-omQ_LWLg.js',
  './assets/Money-DleUjOXt.js',
  './assets/Review-DpaJp7Py.js',
