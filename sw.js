...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-CdjAGD-H.js',
  './assets/Countdown-CDjkcdLF.js',
  './assets/Dashboard-BvKc47zM.js',
  './assets/DeadlinesPage-Cz2gO-Gs.js',
  './assets/GlowCard-D2wNReOB.js',
  './assets/Journal-CTsLmXnY.js',
  './assets/Money-bkvLrGAr.js',
  './assets/Review-aLzPEyru.js',
  './assets/arrow-right-5bO2RMwP.js',
  './assets/chevron-right-BR96mA7C.js',
  './assets/coins-DaIH10N-.js',
  './assets/flag-CXN11PL2.js',
  './assets/index-B_bDWZ3h.js',
  './assets/index-CuMGHf5l.css',
  './assets/maximize-2-Cr8FdduO.js',
  './assets/sparkles-D-9J1CUk.js',
  './assets/trending-up-Dwc43Y3_.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
