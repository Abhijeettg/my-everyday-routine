...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-2Yxa8scy.js',
  './assets/Countdown-UkstNNU0.js',
  './assets/Dashboard-BIQLCTVn.js',
  './assets/DeadlinesPage-BeQBEYfG.js',
  './assets/GlowCard-DRSqlbFO.js',
  './assets/Journal-CtjOsSPL.js',
  './assets/Money-7tUDISXq.js',
  './assets/Review-kf1nkNyY.js',
  './assets/arrow-right-DJSSwhd0.js',
  './assets/chevron-right-DH2UhJji.js',
  './assets/coins-DkbigIzI.js',
  './assets/flag-CmqZ9dyT.js',
  './assets/index-DEoH5RpP.css',
  './assets/index-cV77eGSf.js',
  './assets/maximize-2-B2ZkdYx7.js',
  './assets/sparkles-BGAC2Axt.js',
  './assets/trending-up-5WwEvqrl.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
