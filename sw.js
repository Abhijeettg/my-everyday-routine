...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-BEahdLk6.js',
  './assets/Countdown-BZ1Xr1hF.js',
  './assets/Dashboard-BcJ_Q8yO.js',
  './assets/DeadlinesPage-BEVY6q4T.js',
  './assets/GlowCard-D6Il3GFO.js',
  './assets/Journal-CisSnYG9.js',
  './assets/Money-DTDzKcfs.js',
  './assets/Review-BdRLvXUS.js',
  './assets/arrow-right-BWFD0JYj.js',
  './assets/chevron-right-10rQxGNZ.js',
  './assets/coins-yoPxU31F.js',
  './assets/flag-Nl5MipID.js',
  './assets/index-B29JXLjn.css',
  './assets/index-BH-eLtc6.js',
  './assets/sparkles-BuSiIdHr.js',
  './assets/trending-up-Bz9ogbWl.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
