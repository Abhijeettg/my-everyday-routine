...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-CYu_nsKd.js',
  './assets/Countdown-DBqNzP7j.js',
  './assets/Dashboard-Dkwb0-41.js',
  './assets/DeadlinesPage-SZViA6ch.js',
  './assets/GlowCard-CjDOChh4.js',
  './assets/Journal-CK30n7iA.js',
  './assets/Money-R3TlRa6K.js',
  './assets/Review-xKxKnSGE.js',
  './assets/arrow-right-BZJZ02kD.js',
  './assets/chevron-right-BZVLrcWN.js',
  './assets/coins-pUJwuemU.js',
  './assets/flag-BYsscyPw.js',
  './assets/index-BTWYWXAf.js',
  './assets/index-xsNFbmAk.css',
  './assets/sparkles-B5F94Xv4.js',
  './assets/trending-up-l0KbaQ88.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
