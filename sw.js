...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-4M60tCHo.js',
  './assets/Countdown-B36JFE0W.js',
  './assets/Dashboard-BLlmOQWO.js',
  './assets/DeadlinesPage-bGD0g81n.js',
  './assets/GlowCard-B4FMBsbR.js',
  './assets/Journal-LQNF3T_P.js',
  './assets/Money-BvXMclNp.js',
  './assets/Review-CMM7TPwW.js',
  './assets/arrow-right-R3mHp263.js',
  './assets/chevron-right-Cixbea0L.js',
  './assets/coins-B5C6OMwo.js',
  './assets/flag-DwxigJeK.js',
  './assets/index-B29JXLjn.css',
  './assets/index-DM8a6bzZ.js',
  './assets/sparkles-Cfrfpc9S.js',
  './assets/trending-up-CmBj7der.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
