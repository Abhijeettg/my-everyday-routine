...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-d6NjModa.js',
  './assets/Countdown-D1FaZt4s.js',
  './assets/Dashboard-CcGHS5xB.js',
  './assets/DeadlinesPage-DZchBVUC.js',
  './assets/GlowCard-BUl_0ogE.js',
  './assets/Journal-BEuJsYIh.js',
  './assets/Money-B33Myfka.js',
  './assets/Review-Bcv93I5-.js',
  './assets/arrow-right-BS46-BRz.js',
  './assets/chevron-right-DyeItC2Q.js',
  './assets/coins-DDURQCaf.js',
  './assets/flag-C4kqVEs5.js',
  './assets/index-B6FcFUH8.css',
  './assets/index-D4iRJgwu.js',
  './assets/maximize-2-DgAsenrg.js',
  './assets/sparkles-C_EJ3y_I.js',
  './assets/trending-up-C1KK3sV_.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
