...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-C4SSd9Pk.js',
  './assets/Countdown-CafFA4s7.js',
  './assets/Dashboard-DwJhR7al.js',
  './assets/DeadlinesPage-oHqnf9Nm.js',
  './assets/GlowCard-CoNY_oQ2.js',
  './assets/Journal-8mC25N0F.js',
  './assets/Money-DxXizgK_.js',
  './assets/Review-DzHlDcON.js',
  './assets/arrow-right-spI9Fh_S.js',
  './assets/chevron-right-bbZGXf1k.js',
  './assets/coins-Cqi-cpZm.js',
  './assets/flag-BwcAJi_9.js',
  './assets/index-CBq9_j8c.js',
  './assets/index-CvCihyhi.css',
  './assets/sparkles-CDe8bmVq.js',
  './assets/trending-up-DemYelrv.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
