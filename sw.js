...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-s25xGAt8.js',
  './assets/Countdown-CtRger5B.js',
  './assets/Dashboard-wPnqmDqq.js',
  './assets/DeadlinesPage-cATNuxhe.js',
  './assets/GlowCard-B-QiHjBj.js',
  './assets/Journal-C9M7G1xA.js',
  './assets/Money-DVjWxYfS.js',
  './assets/Review-Bf0gzBgp.js',
  './assets/arrow-right-DjtcO9R2.js',
  './assets/chevron-right-4Q8yRHdf.js',
  './assets/coins-SBGyhbu2.js',
  './assets/flag-B2in64Mk.js',
  './assets/index-CTw3bwjb.js',
  './assets/index-DEoH5RpP.css',
  './assets/maximize-2-DyqS1-XF.js',
  './assets/sparkles-B3Ct_1GE.js',
  './assets/trending-up-BGCn5-I6.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
