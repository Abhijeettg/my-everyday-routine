...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-CnoGvbeK.js',
  './assets/Countdown-DEtXtdTL.js',
  './assets/Dashboard-DDoAJOZ5.js',
  './assets/DeadlinesPage-D7M50cSG.js',
  './assets/GlowCard-By-bTlfH.js',
  './assets/Journal-DSb16z4S.js',
  './assets/Money-DxDOpo8R.js',
  './assets/Review-C-EGkUVh.js',
  './assets/arrow-right-BiH47kLq.js',
  './assets/chevron-right-BH3rv78E.js',
  './assets/coins-6zbAjVXI.js',
  './assets/index-B4rb2nuf.js',
  './assets/index-CpG3owgJ.css',
  './assets/sparkles-woseebJ0.js',
  './assets/trending-up-B4OsS6vx.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
