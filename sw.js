...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-D1k1K1Uv.js',
  './assets/Countdown-DzrzDxJw.js',
  './assets/Dashboard-BohNqldc.js',
  './assets/DeadlinesPage-wO8aoU24.js',
  './assets/GlowCard-BeIWsry9.js',
  './assets/Journal-B-Hu03Jl.js',
  './assets/Money-N2C59lxt.js',
  './assets/Review-BotPRD6X.js',
  './assets/arrow-right-DTDyFE-z.js',
  './assets/chevron-right-CeSlSYYO.js',
  './assets/coins-C7xYdK8u.js',
  './assets/index-HYJjL8yW.css',
  './assets/index-S9G6KLae.js',
  './assets/sparkles-DUOHOwjs.js',
  './assets/trending-up-CcRQjvQx.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
