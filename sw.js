...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-BE68Na_Q.js',
  './assets/Countdown-BXlqkdDQ.js',
  './assets/Dashboard-R7w4jwXf.js',
  './assets/DeadlinesPage-B8Pm5baM.js',
  './assets/GlowCard-DKsf3WL4.js',
  './assets/Journal-BMtd-g3Z.js',
  './assets/Money-Dkjgikj8.js',
  './assets/Review-CyKsqvRa.js',
  './assets/arrow-right-NS2eoZNK.js',
  './assets/chevron-right-BlmTKm_G.js',
  './assets/coins-XrQOd6E1.js',
  './assets/flag-Bp1JeRzU.js',
  './assets/index-BSHCLDCN.js',
  './assets/index-CvCihyhi.css',
  './assets/sparkles-PI7UhS0F.js',
  './assets/trending-up-_elmvDq8.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
