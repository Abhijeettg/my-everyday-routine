...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-DVBWt6I9.js',
  './assets/Countdown-Dsyx2msm.js',
  './assets/Dashboard-Ob9PeGSk.js',
  './assets/DeadlinesPage-DPSGAkgG.js',
  './assets/GlowCard-BbFnChml.js',
  './assets/Journal-8BQNCAjl.js',
  './assets/Money-BLjX9Fix.js',
  './assets/Review-CkJ8oGhu.js',
  './assets/arrow-right-DNVksXrx.js',
  './assets/chevron-right-DWEYQZ0a.js',
  './assets/coins-CxrAdNad.js',
  './assets/flag-DKNDPG1p.js',
  './assets/index-BaCVrHyG.css',
  './assets/index-CZ3gx4p4.js',
  './assets/maximize-2-D3Bbhzt-.js',
  './assets/sparkles-Bb6UnDt6.js',
  './assets/trending-up-MbP1uiMA.js',
  './assets/ui-C6EfVKGb.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
