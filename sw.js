...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-BF-t1CXw.js',
  './assets/Countdown-CEiGjXHU.js',
  './assets/Dashboard-ohcTCmHN.js',
  './assets/DeadlinesPage-BocpLbks.js',
  './assets/GlowCard-Dg3onZkc.js',
  './assets/Journal-CxLr2LIk.js',
  './assets/Money-DFBZMIuU.js',
  './assets/Review-BQvbbVyR.js',
  './assets/arrow-right-DbJ-7sSa.js',
  './assets/chevron-right-Dnqzf2V_.js',
  './assets/coins-C1U6QQJk.js',
  './assets/flag-BAba6TD6.js',
  './assets/index-CdzZwAha.css',
  './assets/index-beSOZm6s.js',
  './assets/sparkles-Ba5WPXlp.js',
  './assets/trending-up-CBRTP6Gs.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
