...
const PRECACHE = [
  './',
  './index.html',
  './assets/Checkout-NT42A1g4.js',
  './assets/Countdown-u5QFkQUF.js',
  './assets/Dashboard-V2FC1fVT.js',
  './assets/DeadlinesPage-ByUz3oC5.js',
  './assets/GlowCard-t1Rorntf.js',
  './assets/Journal-Dx2NWJ5L.js',
  './assets/Money-vaG43pBU.js',
  './assets/Review-DN40Z-VJ.js',
  './assets/arrow-right-DRQav5fh.js',
  './assets/chevron-right-BImgxOpU.js',
  './assets/coins-DnPcv5q7.js',
  './assets/flag-CQDpDL_-.js',
  './assets/index-B29JXLjn.css',
  './assets/index-CeS0p-PM.js',
  './assets/sparkles-DvLg7ihY.js',
  './assets/trending-up-CKeyvski.js',
  './favicon.svg',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
